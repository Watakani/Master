...
DATAPATH_UNPROCESSED = str(dirname) + '/../../../data/unprocessed/power/data.npy'
DATAPATH_PREPROCESSED = str(dirname) + '/../../../data/preprocessed/power/power.hdf5'

class Power(ProcessedData):
